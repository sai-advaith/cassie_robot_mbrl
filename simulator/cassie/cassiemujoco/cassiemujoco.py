...
class CassieSim:
    ...
    def contact(self):
        ...
        foot_positions = []
        for i in range(6):
            foot_positions.append(pos_array[i])

        returnarray = (ctypes.c_double * 12)()
        cassie_sim_foot_forces(self.c, returnarray)
        foot_forces = [returnarray[i] for i in range(12)]
        return (foot_forces, foot_positions)
